...
const settingsNav: SettingsItem[] = [
  ...
  { id: 'account', label: 'Account', icon: <SettingsIcon className="h-4 w-4" /> },
...
const mockUser = {
  ...
  bio: 'Experienced instructor with expertise in web development and programming. Passionate about teaching and helping students succeed.',
...
const sectionMeta: Record<SettingsSection, { title: string; description: string }> = {
  ...
  notifications: {
    ...
    description: 'Choose which updates you want to receive while teaching on the platform.',
  },
  preferences: {
    title: 'Preferences',
              ...
              <Card className="gap-0 rounded-3xl border border-slate-200 py-0 shadow-sm dark:border-zinc-700 dark:bg-zinc-900">
                <CardContent className="space-y-4 p-6 text-center">
                  ...
                  <Badge className="mx-auto rounded-full bg-primary/10 px-3 py-1 text-primary hover:bg-primary/10">
                    {mockUser.membership} Instructor
                  </Badge>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-1">
                      ...
                      <p className="text-sm text-muted-foreground">Get notified about new enrollments and course activity</p>
                    </div>
                    <Checkbox
